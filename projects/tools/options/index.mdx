---
title: "Theme"
description: "Customize Quicko Tools appearance with theme mode and color options based on Material 3 design."
---

Quicko Tools support customization to match your platform's branding. You pass an `options` object that contains theme configuration to generate a complete Material 3 color scheme.

## Structure

The `options` object contains a `theme` key with the following properties:
...
Provide a seed color and Quicko Tools will generate a complete color scheme based on Material 3 specifications. This ensures harmonious colors across the entire tool interface.

<Accordion title="How Material 3 Color Generation Works" icon="palette" defaultOpen>
  Material 3 uses a seed color to derive a complete palette including:
  - Primary, secondary, and tertiary colors
  - Surface and background colors
  - On-color variants for text and icons
  - Error and outline colors

  This approach ensures visual harmony while allowing brand customization.
</Accordion>
...
<AccordionGroup>
  <Accordion title="Use Your Brand's Primary Color" icon="palette" defaultOpen>
    Pass your brand's primary color as the seed. Material 3 will generate complementary colors automatically.
  </Accordion>
