...
<CardGroup cols={2}>
  <Card title="User Details" icon="id-card" href="/connect/api-reference/open-apis/entitlements/user-details">
    Retrieve verified identity of the user, such as name, email, and mobile number.
  </Card>
  <Card title="Tax Payer" icon="contact-round" href="/connect/api-reference/open-apis/income-tax/tax-payer">
    Access high-level details about user demographics, including PAN, name, DOB, age as per PAN, category, residential status.
  </Card>
  <Card title="ITR Details" icon="scroll-text" href="/connect/api-reference/open-apis/income-tax/file/itr-details">
    Get metadata about Income Tax Returns, such as filing status, type of ITR filed, due dates, and acknowledgment number.
  </Card>
  <Card title="Tax Computation" icon="calculator" href="/connect/api-reference/open-apis/income-tax/file/tax-computation">
  ...
  <Card title="Advisory Orders" icon="receipt" href="/connect/api-reference/open-apis/advisory/orders">
...
<Steps>
  ...
  <Step title="Authenticate Your Application">
    Use the [Authenticate API](/connect/api-reference/authentication/authenticate) to get your application's access token.
  </Step>
  
  <Step title="Implement OAuth Flow">
    Follow the [OAuth guide](/connect/guides/getting-started/oauth) to get user consent and obtain Resource Owner tokens.
  </Step>
...
<Card title="Try it with Postman" icon="paper-plane" href="#">
...
<CardGroup cols={3}>
  <Card title="Authentication Guide" icon="key" href="/connect/guides/getting-started/authentication">
    Learn about API authentication
  </Card>
  <Card title="OAuth Flow" icon="shield-check" href="/connect/guides/getting-started/oauth">
    Implement OAuth for user consent
  </Card>
  <Card title="API Reference" icon="book" href="/connect/api-reference">
