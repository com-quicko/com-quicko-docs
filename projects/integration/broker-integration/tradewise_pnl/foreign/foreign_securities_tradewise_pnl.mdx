...
| nature_of_settlement | string | The [nature of the settlement](/projects/integration/broker-integration/tradewise_pnl/foreign/foreign_securities_tradewise_pnl#annexure-2-nature-of-settlement) of transaction |
