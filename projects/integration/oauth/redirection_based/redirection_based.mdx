...
Quicko uses redirection based OAuth journeys to get secure access to apps, just like any modern app may use Google OAuth to get access to your google profile, contacts, calendar, emails etc. Following steps explain a standard OAuth journey:
